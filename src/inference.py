...
parser.add_argument('--restore_from', type=str, default='experiments/base_model/best_weights/best_after_epoch_245.pth.tar', help='Optional, file containing weights to reload before training')
